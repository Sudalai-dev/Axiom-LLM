...
Revision ID: 831c91372c04
Revises: 
Create Date: 2026-07-21 10:38:48.619832
"""
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('audit_events', schema=None) as batch_op:
        batch_op.create_index('idx_audit_tenant_time', ['tenant_id', 'created_at'], unique=False)

    op.create_table('tenants',
    sa.Column('tenant_id', sa.String(length=36), nullable=False),
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.Column('industry', sa.String(length=100), nullable=True),
    sa.Column('isolation_mode', sa.String(length=20), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    ...
    with op.batch_alter_table('usage_metrics', schema=None) as batch_op:
        batch_op.create_index('uq_tenant_metric_date', ['tenant_id', 'metric_date'], unique=True)
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        batch_op.create_index('uq_tenant_user_subject', ['tenant_id', 'external_idp_subject'], unique=True)
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        batch_op.drop_index('uq_tenant_user_subject')
    ...
    with op.batch_alter_table('usage_metrics', schema=None) as batch_op:
        batch_op.drop_index('uq_tenant_metric_date')
